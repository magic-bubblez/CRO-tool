...
async def analyze_page(url: str, gemini_key: str = "", groq_key: str = "", openrouter_key: str = "") -> tuple[str, str]:
    ...
    page_analysis = await call_text(prompt, gemini_key, groq_key, openrouter_key, max_tokens=4000)
